...
Да се имплементирт:
* Правилата на играта;
* Поставяне по дъската ще се оцъществява чрез подаване на координати. Хоризонтално координатите могат да бъдат A, B и C. Съответно вертиналните позиции могат да бъдат 1, 2 или 3;
* Местене на пул се осъществява чрез запис на два последователни координати. Пример: А1А2 (пул в горният ляв ъгъл се мести на дясно).
...
# Задачи по проект №2:
Да се имплементира:
* Запис на входящи координати (например А2 - поставяне на пул, А1А2 - местене на пул). Координатите трябва да бъдат подавани от изпълнителят на проект №1;
