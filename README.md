...
[YouTube Stream](https://youtu.be/EbAJvNI_-CM)
...
Утре (18.03.2020) от 18:00 ще се опитаме да направим стриминг в YouTube и да проведем, лекцията за структурите.
За повече информация следете тази страница. Очаквайте линк към YouTube stream-a.
...
Всички лекции до момента може да намерите на следните [адрес](https://github.com/SwiftFMI/swift_2018_2019/tree/master/lectures)
